...
export const PLAYER_MAX_HP = 100; //100
export const PLAYER_LEVEL_HP_BONUS = 120;
export const PLAYER_MEDKIT_HEAL = 200;
...
// боссы
export const BOSS1_SPAWN_AT = 90; // секунда появления 90
export const BOSS1_HP = 450;
export const BOSS1_SPEED = 65;
export const BOSS1_MELEE_DAMAGE = 65;
export const BOSS2_SPAWN_DELAY = 60; // после смерти босса №1 60
export const BOSS2_HP = 720;
export const BOSS2_SPEED = PLAYER_SPEED * 0.85;
...
export const BOSS2_ENRAGED_SHOTGUN_PELLETS = 15;
