...
export const TEXTURE_MANIFEST = {
  ...
  [TEXTURE_KEYS.PLAYER_ALT_2]: { src: versaPng, tint: "#38bdf8" },
  [TEXTURE_KEYS.PLAYER_ALT_3]: { src: versaPng, tint: "#fbbf24" },
  [TEXTURE_KEYS.PLAYER_ALT_4]: { src: versaPng, tint: "#ef4444" },
  ...
  [TEXTURE_KEYS.BOSS2_ENRAGED]: { src: fogPng, tint: "#ef4444" },
  ...
  [TEXTURE_KEYS.CAT_VARIANT2]: { src: catPng, tint: "#facc15" },
  [TEXTURE_KEYS.CAT_VARIANT3]: { src: catPng, tint: "#38bdf8" },
};

export const SOUND_MANIFEST = {
  [SOUND_KEYS.AMBIENT]: bembMp3,
  [SOUND_KEYS.MELODY]: bembMp3,
  [SOUND_KEYS.PLAYER_ATTACK]: none,
  [SOUND_KEYS.PLAYER_HIT]: none,
  [SOUND_KEYS.ENEMY_HIT]: none,
  [SOUND_KEYS.ENEMY_DIE]: none,
  [SOUND_KEYS.PICKUP]: none,
  [SOUND_KEYS.MEDKIT]: none,
  [SOUND_KEYS.MINE_EXPLODE]: none,
  [SOUND_KEYS.LEVEL_UP]: none,
  [SOUND_KEYS.WITCH_SHOOT]: none,
  [SOUND_KEYS.MONSTER_SPAWN]: none,
  [SOUND_KEYS.BOSS2_PHASE]: none,
  [SOUND_KEYS.RESCUE_SPAWN]: none,
  [SOUND_KEYS.BOSS3_SPAWN]: none,
  [SOUND_KEYS.WALL_BREAK]: none,
};
